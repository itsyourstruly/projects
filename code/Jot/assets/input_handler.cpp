    ...
    switch(ch) {
        ...
        case KEY_LEFT: {
            ...
            if (currentCol > 0) {
                ...
                if (lastSlash != std::string::npos) {
                    ...
                    needsRefresh = true; // Refresh file list after going back
                }
            }
            break;
        }
        ...
        case KEY_ENTER: // Enter key
            if (!files.empty()) {
                ...
                if (selected.length() >= 2 && selected.substr(0, 2) == TEXT_FOLDER_LABEL) {
                    ...
                    needsRefresh = true; // Refresh file list after entering folder
                } else {
            ...
            if (!filename.empty()) {
                ...
                if (templateIndex == -1) {
                    ...
                    if (fileExists(filename)) {
                        ...
                        needsRefresh = true; // Refresh file list after creating file
        ...
        case KEY_NEW_FOLDER - 32: { // Handle uppercase
            ...
            if (!foldername.empty()) {
                if (fileExists(foldername)) {
                    ...
                    needsRefresh = true; // Refresh file list after creating folder
        ...
        case KEY_RENAME - 32: { // Handle uppercase
            if (!files.empty()) {
                ...
                if (!newName.empty() && newName != oldName) {
                    ...
                    needsRefresh = true; // Refresh file list after renaming
        ...
        case KEY_DELETE_ALT - 32: { // Handle uppercase 'D'
            ...
            if (!g_selectedPaths.empty()) {
                ...
                if (confirm == 'y' || confirm == 'Y' || confirm == '\n' || confirm == KEY_ENTER || confirm == 10) {
                    ...
                    needsRefresh = true; // Refresh file list after deleting
        ...
        case 'V': {
            ...
            if (!g_selectedPaths.empty()) {
                ...
                if (moveCount > 0) {
                    ...
                    needsRefresh = true; // Refresh file list after moving
        ...
        case KEY_UNDO_ACTION - 32: { // Handle uppercase 'Z'
            bool undoSuccess = performUndo(statusMessage);
            if (undoSuccess) {
                needsRefresh = true; // Refresh file list after undo
            }
            break;
        }
    }
